...
if ($filtre === 'Toutes') {
    $stmt = $pdo->query("SELECT * FROM bien WHERE categorie = 'Location' ORDER BY date_creation DESC");
} else {
    $stmt = $pdo->prepare("SELECT * FROM bien WHERE categorie = 'Location' AND (titre LIKE ? OR description LIKE ?) ORDER BY date_creation DESC");
    ...
    <main class="container listing-page">
        <div class="page-header">
            ...
            <div class="filter-tabs">
                <a href="louer.php?filtre=Toutes" class="filter-tab <?= ($filtre==='Toutes')?'active':'' ?>">Toutes</a>
            </div>
        </div>
